...
The LCD used in the arduino sketch is parallax 2x16 LCD, parallax part # 27977.  I have a repo for that, too: https://github.com/hubbsy/parallax_LCD_27977.git  It's not a full arduino library, but the friendly names win the header file for the LCD make it pretty easy to use!